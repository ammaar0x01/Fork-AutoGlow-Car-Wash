    ...
    const actionCards = [
        {
            ...
            icon: employeesIcon,
            buttons: [
                { label: "View Profile", path: "/employee/profile" },
                { label: "Edit Profile", path: "/employee/profile-edit" }
            ]
        },
        {
            title: "View Bookings",
            ...
            icon: bookingsIcon,
            buttons: [
                { label: "View Bookings", path: "/employee/bookings" }
            ]
        },
        {
            title: "Performance",
            ...
            icon: servicesIcon,
            buttons: [
                { label: "View Services", path: "/employee/performance" }
            ]
        },
        {
            ...
            icon: employeesIcon,
            buttons: [
                { label: "View Customers", path: "/employee/manage-customers" }
            ]
        },
          {
